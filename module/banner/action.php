<?php
    ...
    header("location:".BASE_URL."index.php?page=my_profile&module=banner&action=list&notif=success");
    }
    ...
    header("location:".BASE_URL."index.php?page=my_profile&module=banner&action=list&notif=updated");
    }
