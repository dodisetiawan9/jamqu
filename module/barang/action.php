<?php
	...
	header("location:".BASE_URL."index.php?page=my_profile&module=barang&action=list&notif=success");
	}
	...
	header("location:".BASE_URL."index.php?page=my_profile&module=barang&action=list&notif=updated");
	}
